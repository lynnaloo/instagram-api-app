...
--
-- Host: localhost    Database: grow-template
-- ------------------------------------------------------
...
CREATE TABLE `sample_table` (
  `id` int(11) NOT NULL,
  `sample_column` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `sample_table` VALUES (1,'hello world');
...
-- Dump completed on 2013-09-24  9:58:30
